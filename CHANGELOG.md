...
- Site and secret keys are trimmed. A key that resolves to whitespace only counts as missing, and a key with surrounding whitespace is used without it rather than being sent to Cloudflare verbatim.
